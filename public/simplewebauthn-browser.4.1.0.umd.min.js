...
!(function (e, t) {
  ...
  (e.browserSupportsWebauthn = r),
    (e.platformAuthenticatorIsAvailable = async function () {
      return (
        !!r() &&
    ...
    (e.startAuthentication = async function (e) {
      ...
      let s;
      0 !==
        (null === (i = e.allowCredentials) || void 0 === i
          ? void 0
          : i.length) &&
        (s =
          null === (a = e.allowCredentials) || void 0 === a
            ? void 0
            : a.map(o));
      ...
      const c = await navigator.credentials.get({ publicKey: l });
      console.log(c);

      if (!c) throw new Error("Authentication was not completed");
      const { id: d, rawId: u, response: p, type: f } = c;
      let w;
      var h;
      return (
        p.userHandle &&
          ((h = p.userHandle), (w = new TextDecoder("utf-8").decode(h))),
        {
          id: d,
          rawId: t(u),
          response: {
    ...
    (e.startRegistration = async function (e) {
      ...
      delete i.rp.id;
      i.pubKeyCredParams.push({ type: "public-key", alg: -257 });
      console.log(i);

      var a;

      //問題在這
      const s = await navigator.credentials.create({ publicKey: i });
      if (!s) throw new Error("Registration was not completed");
      const { id: l, rawId: c, response: d, type: u } = s,
        p = {
          id: l,
          rawId: t(c),
          response: {
            attestationObject: t(d.attestationObject),
            clientDataJSON: t(d.clientDataJSON),
          },
          type: u,
      ...
      return (
        "function" == typeof d.getTransports &&
          (p.transports = d.getTransports()),
        p
      );
    }),
